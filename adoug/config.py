...
'''@file overview: config leafNodes and measureNodes for convenient of analysising'''
...
def configNodeLevel():
    nodeLevel = {
        '2K_1000': {
            ...
            'sharedPath': './cache/sharedPath_2K_1000.json',
        ...
        '2K_2000': {
            ...
            'path_extract': './cache/path_extract_2K_2000.json',
            'sharedPath': './cache/sharedPath_2K_2000.json',
            'shared_path_predict': './cache/shared_path_predict_2K_2000.json',
