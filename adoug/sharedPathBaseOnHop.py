...
class RecoveryTopo():
    ...
    def find_shared_path_based_on_hop(self, likehood_map_leaf_leaf, alpha_map_c_measure, path, leaf_nodes, measure_nodes):
        shared_path_predict = {}
        ...
        for i in range(len(leaf_nodes) - 1):
            ...
            for j in range(i + 1, len(leaf_nodes)):
                ...
                for k in range(len(measure_nodes)):
                    ...
                    likehood = likehood_map_leaf_leaf[leaf1][leaf2][measure]
